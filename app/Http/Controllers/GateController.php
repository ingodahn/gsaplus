...
class GateController extends Controller
{
	...
	// public function save_patient_data($Code, $Name, $Password, $eMail, $Day)
	{
		...
		if ($userExists) {
			...
			Alert::danger("Ihre Registrierung ist leider fehlgeschlagen. Bitte wählen Sie einen anderen Benutzernamen.")->flash();
...
//					leider fehlgeschlagen, Bitte wählen Sie einen anderen Benutzernamen");
			...
			Alert::info('Sie haben sich erfolgreich registriert und können sich nun einloggen.');
			return redirect('/');
		}
	}
	 ...
	 *
	 * System pr�ft, ob der Code in der Datenbank vorhanden und noch nicht belegt ist.
	 * Die Begr��ungsseite wird im Erfolgsfall angezeigt. Ansonsten wird der Benutzer
	 * informiert
	 *
