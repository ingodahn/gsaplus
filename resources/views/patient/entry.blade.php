  ...
  <div class="container">
    ...
    <form data-parsley-validate role="form" action="/SaveAssignment/{{ $PatientInfo['name'] }}/{{ $EntryInfo['week'] }}" method="post">
      ...
      @if($EntryInfo['week'] > 1 )
        ...
        @elseif($isTherapist && $EntryInfo['week'] > 1 && $EntryInfo['status'] < 'E020')
          <p>
          <div class="form-group">
        ...
        @endif
      @else
        <p><em>Bitte beschreiben Sie verschiedene Situationen bezüglich der Rückkehr an Ihren Arbeitsplatz...</em></p>
      @endif

      <?php
        $visible = $isPatient || $isTherapist &&  $isTherapist && $EntryInfo['week'] <= 1;
