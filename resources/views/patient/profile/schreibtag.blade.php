...
@if($isPatient && $Patient['assignmentDayChangesLeft'] > 0)
  <form data-parsley-validate role="form" action="/patient/{{$Patient['name']}}/day_of_week" method="post">
    ...
    <div class="form-group">
      ...
      <a href="javascript:void(0)" data-toggle="popover" class="btn" data-trigger="focus" title="Warum sind nicht alle Wochentage wählbar?" data-content="Wir möchten, dass Sie nach dem Schreiben Ihres Tagebuchs möglichst innerhalb von 24 h eine Rückmeldung Ihres Online-Therapeuten erhalten. Da wir dies jedoch nur von Montag bis Freitag mit begrenzten Kapazitäten zusagen können, sind nicht alle Tage als Schreibtage wählbar.">
