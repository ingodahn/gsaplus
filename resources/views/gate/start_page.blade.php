      ...
      <div class="col-md-4">
        ...
        <form action="/register" method="post">
          ...
          <div class="form-group">
            ...
            <a href="javascript:void(0)" data-toggle="popover" role="button" class="btn" data-placement="top" data-trigger="focus" data-html="true"  title="Persönlicher Code" data-content="Die Registrierung ist nur mit einem Code möglich, den Sie im Rahmen des GSA-Online plus Programms erhalten haben.<br>Bei Problemen wenden Sie sich bitte an unser Team. Nutzen Sie hierzu den Menüpunkt 'Kontakt' unten.">
