      ...
      <div class="col-md-4">
        ...
        <form action="/StartRegistration" method="post">
          ...
          <div class="form-group">
            ...
            <a href="javascript:void(0)" data-toggle="popover" data-placement="top" data-trigger="focus" title="Persönlicher Code" data-content="Die Registrierung ist nur mit einem Code möglich, den Sie im Rahmen des GSA online plus Programms erhalten haben. Bitte wenden Sie sich bei Problemen an unser Team. Nutzen Sie hierzu den Menüpunkt 'Kontakt'.">
